...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0A0F1E,25:0D1B3E,60:0A3D2E,100:10B981&height=260&section=header&text=Orbital%20Insight&fontSize=68&fontColor=ffffff&fontAlignY=38&animation=fadeIn&desc=Autonomous%20Satellite%20Collision%20Management%20System%20%7C%20NSH%202026&descAlignY=58&descSize=18&descAlign=50" width="100%" alt="Orbital Insight Banner"/>
...
![Build](https://img.shields.io/badge/⏱️_Built_In-15_Days-8B5CF6?style=flat-square&labelColor=0A0F1E)
...
team = {
    ...
    "built_in" :  "15 days, 4 sleepless nights, during midterms 💀",
...
## 🌍 What Is This Project? (Team BroCODE Explains!)

> *"Okay so imagine you're playing a video game — but instead of one character, you're controlling **55 spaceships** flying around Earth at 25,000 km/h. And there are **15,000 pieces of space junk** flying in random directions. If even one spaceship hits even one tiny piece of junk... 💥 explosion. And that explosion creates MORE junk. Which hits MORE satellites. It's called Kessler Syndrome and it would basically end the internet for Earth.*
>
...
>
> *That's what we built in 15 days. Here's how it works 👇"*
>
> — **Team BroCODE, NSH 2026**

## 🌍 What Is This Project? (In Simple Words)

Imagine you're playing a video game where you control **55 spaceships** flying around Earth. But here's the problem — there are also **15,000 pieces of space junk** flying around at super high speeds (like 7 km per second — that's faster than a bullet!). If even one spaceship crashes into a piece of junk, it explodes and creates even MORE junk. Bad news.

**Orbital Insight** is the smart system that:
- 👀 **Watches** all 55 satellites and 15,000 debris objects every second
- 🧠 **Predicts** if any satellite is about to crash using an AI brain
- 🚀 **Automatically fires thrusters** to dodge the debris before it's too late
- 📊 **Shows everything** on a beautiful live dashboard so humans can watch

> Think of it like a **self-driving car**, but for satellites in space — and instead of avoiding other cars, it avoids floating space junk at 25,000 km/h.

**Built by Team BroCODE for NSH 2026 Hackathon at IIT Delhi.**

---

## ⚡ Quick Start (How to Run It)

> **Think of this like installing and starting a video game** — just 3 steps!

```bash
# Step 1: Create fake training data (like making practice levels for our AI)
cd backend
python generate_data.py

# Step 2: Train the AI brain using that data
python train_model.py

# Step 3: Start everything at once using Docker (like pressing Play)
cd ..
...
> **Think of this like the rooms in a house** — each file has one job.

```
V2/                              ← 🏠 Root folder — the whole project lives here
│
├── 📁 backend/                  ← 🧠 The smart brain of the system
│   ├── 📁 __pycache__/          ← 🗑️ Python's auto-generated cache (ignore this)
│   ├── 📁 missed_cases.csv/     ← 📝 Folder storing AI mistakes for retraining
│   ├── 📁 training_data.csv/    ← 🏋️ Folder with all training examples
│   ├── collision_model.pkl      ← 💾 The saved AI brain (10,773 KB — it's big!)
...
│   ├── model_threshold.pkl      ← ⚖️ How confident AI must be before sounding alarm
...
│
├── acm.txt                      ← 📄 ACM system notes/config
...
## 🏗️ How Everything Connects (Architecture)

> **Think of this like a restaurant kitchen** — different stations, all working together.

```
┌──────────────────────────────────────────────────────────────┐
│                      Docker Container                        │
│            (like a lunchbox that holds everything)           │
│                                                              │
│  ┌─────────────┐    ┌──────────────────────────────────┐    │
...
│  │  (The Manager's office — shows all the stats)         │   │
│  └───────────────────────────────────────────────────────┘   │
└──────────────────────────────────────────────────────────────┘
```

**In simple words:**
- 🍽️ **Nginx** = The waiter. Shows you the pretty map. Doesn't think, just displays.
- 👨‍🍳 **FastAPI** = The chef. Does ALL the hard work — physics, AI predictions, decisions.
- 📊 **Streamlit** = The manager's dashboard. Shows reports, charts, AI explanations.
- 📦 **Docker** = The lunchbox. Packs everything so it runs the same everywhere.

---

## 🛰️ The Satellite Fleet

> **55 satellites flying in 3 groups** — like 3 different bus routes around Earth.

| Group Name | Height Above Earth | Tilt of Orbit | How Many |
|-----------|-------------------|---------------|---------|
| 🔵 Alpha Shell | 550 km up | 53° tilt | 22 satellites |
| 🟢 Beta Shell | 570 km up | 70° tilt | 18 satellites |
| 🟡 Gamma Shell | 560 km up | 97.6° (pole-to-pole) | 15 satellites |
| **Total** | — | — | **55 satellites** |

**The danger zone:** 15,000 pieces of space junk floating between 300–800 km altitude. Each one moving at ~7 km/s. Even a marble-sized piece can destroy a satellite.
...
|-------|-------------------------------|
| **DART Booster** | Like having 500 experts, but we randomly silence some so they don't all copy each other |
| **Focal Loss** | We make the AI study the HARD examples more — like a student focusing on tough questions |
| **Optuna HPO** | A robot that tries 60 different settings to find the best configuration automatically |
...
| Test Score | Result |
|-----------|--------|
| ROC-AUC (overall accuracy) | **1.0000** 🏆 (perfect!) |
| Average Precision | **1.0000** 🏆 |
| Recall (catching real dangers) | **99.92%** |
...
🛰️ Satellite approaches debris
         ↓
🤖 AI says: "Safe — no danger"    BUT    📐 Physics formula says: "DANGER!"
         ↓
...
|---------|-------|---------------|
| Earth's gravity pull | 398,600 km³/s² | How hard Earth pulls satellites |
| Earth's radius | 6,378 km | Size of Earth |
| J2 (squish factor) | 0.00108263 | How squished Earth is |
| Satellite fuel | 50 kg | Total fuel per satellite |
| Max thruster burn | 15 m/s change | How hard one burn can push |
...
|---------|----------|----------------|
| 🇮🇳 ISTRAC Bengaluru | India | ISRO's main tracking station |
| 🇳🇴 Svalbard | Arctic Norway | Perfect for polar satellites (Gamma shell) |
| 🇺🇸 Goldstone | California desert | NASA's deep space network |
| 🇨🇱 Punta Arenas | Southern Chile | Southern hemisphere coverage |
| 🇮🇳 IIT Delhi Ground Node | Delhi | Hackathon's home base! |
| 🇦🇶 McMurdo Station | Antarctica | South pole coverage |
...
| Uptime | Score |
|--------|-------|
| 99%+ of satellites in their box | Full 15 points |
| 95%+ | ~12 points |
| 90%+ | ~9 points |
...
```json
{
  "time": "2026-03-26T13:14:22",
  "level": "WARNING",
  "event": "conjunction_evasion_planned",
  "satellite": "SAT-Alpha-07",
  "debris": "DEB-03841",
  "miss_distance_meters": 47.3,
  "crash_probability": 0.000214,
  "burn_scheduled": true,
  "ground_station_uplink": "GS-002",
...
|---------|---------|-------------|
| `POST` | `/api/telemetry` | Feed in satellite/debris positions |
| `POST` | `/api/simulate/step` | Advance time by N seconds |
| `POST` | `/api/maneuver/schedule` | Schedule a thruster burn |
| `GET` | `/api/visualization/snapshot` | Snapshot of entire fleet |
...
| What It Does | Technology Used | Simple Explanation |
|-------------|----------------|-------------------|
...
| Base OS | Ubuntu 22.04 | Required by NSH 2026 rules |
...
*Built with ❤️, lots of ☕, 4 sleepless nights, and during midterms by **Team BroCODE** for NSH 2026 · IIT Delhi*
